...
const Canvas = require("hh-mm-ss"); //npm i canvas
const prefix = "!" // برفكس
...
client.on('message', message => {
    ...
    .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=557605571562569739&permissions=8&scope=bot id&permissions=8&scope=bot`)  // حط اي دي بوتك
...
client.login("NTU3NjA1NTcxNTYyNTY5NzM5.D3KuLg.SjpN7zd3ZycfVb2UezONmuE7s4M");  // توكن حقق
